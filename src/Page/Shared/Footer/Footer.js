...
const Footer = () => {
    return (
        <div>
            ...
            <div className="pt-3 pb-1 nav-bg mb-2">
                <p className="text-white">Copyright &copy; 2021-All Rights Reserved- <Link className="text-warning fs-5" to="https://www.ashrafulislambd.com">ashrafulislambd.com</Link></p>
            </div>
        </div>
    );
};
