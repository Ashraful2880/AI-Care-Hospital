...
const Login = () => {
    const {signInHandler,handleEmail,handlePassword,user}=useAuth();
    return (
        <div>
            <div className="flex mt-4 border-0 shadow-2xl rounded-3xl w-8/12 mx-auto py-16">
                <div className="login-area w-6/12">
                    <form onSubmit={signInHandler} className="login-design border-2 w-96 mx-auto h-auto pb-10 rounded-3xl shadow-2xl mt-8">
                        <div>
                        ...
                        <div>
                            <input onClick={handlePassword} className="p-3 w-80 my-3 border-blue-400 border-b-2 text-xl focus:outline-none" type="password" placeholder="Your Password" />
                        </div>
                        <div>
