...
const Appointment = () => {
    return (
        <div>
            ...
            <div className="appoint-container flex rounded-3xl mx-40 mt-4 pb-10 shadow-2xl">
                <div className="w-6/12 md:w-full sm:w-full mt-20 border-r-2 border-blue-300 border-dashed">
                    <div className="md:w-full sm:w-full">
                        <input className="py-3 px-5 border-2 rounded-lg w-6/12 text-xl focus:outline-none focus:ring-2 focus:ring-blue-400 mb-5 md:w-full" type="text" placeholder="Your Name"/>
                    </div>
                    <div className="md:w-full sm:w-full">
                ...
                <div className="w-6/12 md:w-full sm:w-full">
