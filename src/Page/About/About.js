    ...
    return (
        <div>
            <div className="w-full">
                ...
                <img className="mx-auto sm:w-full" src={shape} alt="" />
            </div>
            <div className="flex container mx-auto py-10 about-area sm:block">
                ...
                <div className="w-6/12 p-10  shadow-2xl ml-10 about-text sm:w-full sm:ml-0">
