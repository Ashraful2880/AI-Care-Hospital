...
const About = () => {
    return (
        <div>
            ...
            <div className="flex container mx-auto py-10 about-area">
                <div className="w-6/12 border-r-2 border-blue-300 about-image">
                    <img className="shadow-2xl" src={about} alt="aboutImage" />
                </div>
                <div className="w-6/12 p-10  shadow-2xl ml-10 about-text">
